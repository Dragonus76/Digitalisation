...
<?php
	...
	// echo " </li>\n";
		...
		echo "\t\t<li>";
	echo $this->Html->link('Retour à l\'administration', array('controller'=>'dashboards', 'action' => 'index'));
	echo " </li>\n";
...
<?php endif; ?>
	<div class="actions">
		...
		<ul>
			<li><?php echo $this->Html->link('Retour à l\'administration', array('controller'=>'dashboards', 'action' => 'index')); ?> </li>
		</ul>
<!-- 		<ul>
