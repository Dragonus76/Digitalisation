...
<div class="row minha">
    ...
    <div class="small-12 medium-8 large-8 columns nopuce">
        <h4>Liste des membres de la famille <?php echo $family['Family']['name']; ?></h4>
        <p>Vous n'avez pas ajouté de proches à cette famille</p>
        <?php
            echo '<p><span class="custom-label">'.$this->Html->link('Ajouter une personne',array('controller'=>'defunts','action'=>'add',$id)).'</span></p>';
        ?>
    </div>
</div> 
<?php else : ?>
<div class="row minha">
       <?php echo $this->element('bord'); ?>
    <div class="small-12 medium-8 large-8 columns nopuce">
        <h4>Liste des membres de la famille <?php echo $personnes[0]['Family']['name']; ?></h4>
        <table>
        	 <?php
        ...
        <?php
        	echo '<p><span class="custom-label">'.$this->Html->link('Ajouter un proche',array('controller'=>'defunts','action'=>'add',$personnes[0]['Family']['id'])).'</span></p>';
        ?>
    </div>
</div> 
<?php endif ?>           