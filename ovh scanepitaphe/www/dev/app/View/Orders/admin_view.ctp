<div class="row minha">
	...
	<h4>Commande n°<?php echo $order['Order']['cleref'];?> - <?php echo $this->Html->link('<i class="fa fa-print"></i>',array('controller'=>'orders','action'=>'pview',$order['Order']['id']), array(
			...
			foreach ($array as $key => $value) {
				...
				echo '<tr>';
					...
					echo '<td>'.$this->Html->image(substr($value['Image'],35),array(
						'url' => array('controller' => 'orders', 'action' => 'sendfilejpg',$order['Order']['id'],$numkey['9'],$fileb, $nomqr,'admin'=>false
							))).'</td>';
