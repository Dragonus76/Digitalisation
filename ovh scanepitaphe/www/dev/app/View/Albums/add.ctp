<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Ajouter un album pour la page de <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        <?php
            ...
            echo $this->Form->input('name',array('label' => '1 - Nom de l\'album', 'placeholder'=>'renseignez le nom de l\'album','class' => 'ckeditor'));
            echo $this->Form->input('date', array(
                                            'label' => '2 - Date de l\'évènement',
                                            'dateFormat' => 'DMY',
                                            'minYear' => date('Y') - 2000,
                                            'maxYear' => date('Y'),
                                            'separator'=>'',
