<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Ajouter un contenu sonore (mp3) sur la page de <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        <?php
            ...
            echo $this->Form->input('name',array('label' => '1 - Ajouter un titre à ce contenu sonore', 'placeholder'=>'renseignez le titre de votre son','class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => '3 - Ajoutez une description','rows' => '5','placeholder'=>'description de votre son', 'class' => 'ckeditor'));
