...
<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Liste des contenus textes pour <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
        ...
        <p>Vous n'avez pas ajouté de contenu texte</p>
        <?php
            echo '<p>Il vous reste '.$limit['Limit']['text'].' texte(s) gratuit(s) à ajouter.</p>';
            echo '<p><span class="custom-label">'.$this->Html->link('Ajouter un texte',array('controller'=>'media','action'=>'addtexteind',$personne['Defunt']['id'])).'</span></p>';
        ?>
    </div>
    </div>
</div>
...
<div class="row minha">
            ...
            <tr>
             ...
             <?php
                foreach ($medias as $key => $value) {
                    ...
                    echo '<td>'.$this->Html->link('Modifier',array('controller'=>'media','action'=>'edittext',$value['Media']['id'])).'</td>';
                    echo '<td>'.$this->Html->link("Supprimer ce contenu",array('controller'=>'media','action'=>'deletetext',$value['Media']['id']),null,'Voulez vous vraiment supprimer ce contenu ? Cette action est DEFINITIVE.');
    ...
    <?php unset($posts); ?>
        ...
        <?php
            ...
            echo '<p>Il vous reste '.$limit['Limit']['text'].' texte(s) gratuit(s) à ajouter.</p>';
            echo '<p><span class="custom-label bgviolet">'.$this->Html->link('Ajouter un texte',array('controller'=>'media','action'=>'addtexteind',$personne['Defunt']['id'])).'</span></p>';
            }
        ?>
    </div>
</div>
