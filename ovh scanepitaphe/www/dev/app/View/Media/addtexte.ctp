<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Ajouter un contenu texte sur la page d'une personne</h3>
        </div>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        <?php
            ...
            echo $this->Form->input('name',array('label' => '2 - Ajoutez un titre au texte', 'placeholder'=>'renseignez le titre de votre texte','class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => '4 - Ajoutez votre texte','rows' => '5','placeholder'=>'écrivez votre texte', 'class' => 'ckeditor'));
        echo $this->Form->input('tags',array('label'=>'5 - Renseignez des mots clés (séparés par une virgule) (facultatif) <a href="#" data-reveal-id="myModal" data-reveal title="Besoin d\'aide?"><i class="fa fa-question-circle"></i></a>
            ...
            echo $this->Form->input('category_id', 
                              array(
                              'label' => '6 - Choississez une éventuelle catégorie pour ce texte (facultatif) <a href="#" data-reveal-id="myModal2" data-reveal title="Besoin d\'aide?"><i class="fa fa-question-circle"></i></a>
