<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Ajouter un contenu vidéo sur la page de <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        <?php
            ...
            echo $this->Form->input('name',array('label' => '1 - Ajoutez un titre pour la vidéo', 'placeholder'=>'renseignez le titre de votre texte','class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => '3 - Ajoutez une description','rows' => '5','placeholder'=>'description de la vidéo', 'class' => 'ckeditor'));
            ...
            echo $this->Form->input('adressevideo',array('label' => '6 - Ajoutez l\'adresse de la vidéo Youtube  <a href="#" data-reveal-id="myModal" data-reveal title="Besoin d\'aide?"><i class="fa fa-question-circle"></i></a>
                  <div id="myModal" class="reveal-modal" data-reveal>
                    ...
                    <a class="close-reveal-modal">&#215;</a>
                  </div>', 'placeholder'=>'coller l\'adresse'));
