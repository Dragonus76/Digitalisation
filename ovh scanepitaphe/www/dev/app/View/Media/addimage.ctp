<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Ajouter une image sur la page d'une personne</h3>
        </div>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        <?php
            ...
            echo $this->Form->input('name',array('label' => '2 - Ajoutez un titre pour l\'image', 'placeholder'=>'renseignez le titre de votre image','class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => '4 - Ajoutez une légende pour l\'image','rows' => '5','placeholder'=>'légende de votre image', 'class' => 'ckeditor'));
            ...
            echo $this->Form->input('nomfichier_url',array('label' => '6 - Choississez un fichier pour l\'image', 'type' => 'file'));

            echo $this->Form->input('category_id', 
                              array(
                              'label' => '7 - Choississez une éventuelle catégorie pour cette image (facultatif) <a href="#" data-reveal-id="myModal2" data-reveal title="Besoin d\'aide?"><i class="fa fa-question-circle"></i></a>
                ...
                echo $this->Form->input('album_id', 
                              array(
                              'label' => '8 - Choississez un éventuel album pour cette image (facultatif) <a href="#" data-reveal-id="myModal2" data-reveal title="Besoin d\'aide?"><i class="fa fa-question-circle"></i></a>
                  <div id="myModal2" class="reveal-modal" data-reveal>
                    <h2>Les albums</h2>
                    <p>Pour ajouter un contenu à un album, vous devez avoir créé cet album au préalable.</p>
                    <a class="close-reveal-modal">&#215;</a>
                  </div>'));
                $this->Js->get('#MediaDefuntId')->event('change', 
            ...
            echo $this->Form->input('comment',array('label' => '9 - Autoriser les commentaires'));
