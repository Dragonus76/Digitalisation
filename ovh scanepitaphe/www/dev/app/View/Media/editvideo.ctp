<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Modifier un contenu vidéo sur la page de <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        <?php
            ...
            echo $this->Form->input('name',array('label' => '1 - Titre de la vidéo', 'placeholder'=>'renseignez le titre de votre vidéo','class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => '3 - Description de la vidéo','rows' => '5','placeholder'=>'description de la vidéo', 'class' => 'ckeditor'));
            ...
            echo $this->Form->submit('Modifier ce texte',array('class'=>'buttonvioletokfull postfix')); 
            echo $this->Form->end();
        ?>
      </div>
    </div>
