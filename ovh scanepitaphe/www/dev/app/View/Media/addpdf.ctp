    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        <?php
            ...
            echo $this->Form->input('name',array('label' => '2 - Ajoutez un titre pour le pdf', 'placeholder'=>'renseignez le titre de votre pdf','class' => 'ckeditor'));
            ...
            echo $this->Form->input('nomfichier_url',array('label' => '5 - Choississez un fichier pour pdf', 'type' => 'file'));

            echo $this->Form->input('category_id', 
                              array(
                              'label' => '6 - Choississez une éventuelle catégorie pour ce pdf (facultatif) <a href="#" data-reveal-id="myModal2" data-reveal title="Besoin d\'aide?"><i class="fa fa-question-circle"></i></a>
