<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3>Ajouter un pdf sur la page de <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        <?php
            ...
            echo $this->Form->input('name',array('label' => '1 - Ajoutez un titre pour le pdf', 'placeholder'=>'renseignez le titre de votre pdf','class' => 'ckeditor'));
            ...
            echo $this->Form->input('tags',array('label'=>'3 - Renseignez des mots clés (séparés par une virgule) (facultatif) <a href="#" data-reveal-id="myModal" data-reveal title="Besoin d\'aide?"><i class="fa fa-question-circle"></i></a>
            ...
            echo $this->Form->input('nomfichier_url',array('label' => '5 - Choississez un fichier pour le pdf', 'type' => 'file'));
            echo $this->Form->input('comment',array('label' => '6 - Autoriser les commentaires'));
            
            echo $this->Form->submit('Ajouter ce pdf',array('class'=>'buttonvioletokfull postfix')); 
            echo $this->Form->end();
        ?>
        <?php else : ?>
        <p>Vous avez atteint votre limite de <?php echo $limit['Limit']['limitpdf']; ?> pdf. Pour obtenir des contenus supplémentaires, rendez vous dans le Scanshop (bientôt disponible).</p>
        <?php endif ?>
      </div>
    </div>
</div>   
