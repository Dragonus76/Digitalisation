...
class OptionsController extends AppController {
    ...
    if ($this->request->is('post')) {
        ...
        if ($this->Menu->save($this->request->data)) {
          $id=$this->Menu->id;
            ...
            $this->Session->SetFlash('Menu ajouté',"default",array('class' => 'alert-box success radius'));

        return $this->redirect(array('action' => 'admin_liste'));
    }
        $this->Session->setFlash('Impossible d\'ajouter au menu',"default",array('class' => 'alert-box warning round'));
    }
}
    ...
    public function admin_delete ($id = null) {
        ...
        if ($this->Menu->delete($id)) {
            ...
            $this->Session->setFlash('Le menu avec l id : %s a été supprimé.', h($id),"default",array('class' => 'alert-box success radius'));
