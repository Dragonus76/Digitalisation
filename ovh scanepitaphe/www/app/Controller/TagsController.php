...
class TagsController extends AppController {
    ...
    if ($this->request->is('post')) {
        ...
        if ($this->Tag->save($this->request->data)) {
            $this->Session->SetFlash(__('Tag ajouté'),"default",array('class' => 'alert-box success radius'));
        return $this->redirect(array('action' => 'index'));
    }
        $this->Session->setFlash(__('Impossible d\'ajouter un tag'),"default",array('class' => 'alert-box warning round'));
    }
}
	...
	public function delete ($id = null) {
        ...
        if ($this->Tag->delete($id)) {
            ...
            $this->Session->setFlash(__('Le tag a été supprimé.'),"default",array('class' => 'alert-box success radius'));
        return $this->redirect(array('action' => 'index'));
        }
    }
...
public function edit ($id = null) {
        ...
        if ($this->request->is(array('post','put'))) {
            ...
            $this->Session->setFlash(__('Impossible de mettre à jour le tag'),"default",array('class' => 'alert-box warning round'));
        }
