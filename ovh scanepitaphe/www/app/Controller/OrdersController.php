...
class OrdersController extends AppController {
                ...
                if($this->Order->validates()){
                    if($this->Order->save($this->request->data)){
                        ...
                        if(!empty($client['User']['email'])){
                            ...
                            $CakeEmail->subject(__('Votre colis est en cours de livraison'));
                            $CakeEmail->viewVars(array('colissimo'=>$this->request->data['Order']['colissimo']) );
                            $CakeEmail->emailFormat('text');
                            $CakeEmail->template('livraison');
                            $CakeEmail->send();
                            $this->Session->setFlash(__('Numéro Colissimo enregistré. Email envoyé au client'),"default", array('class' => 'alert-box success radius'));
                            }else{
                        $this->Session->setFlash(__('Numéro Colissimo enregistré. Pas d\'email envoyé au client'),"default", array('class' => 'alert-box success radius'));
 ...
 public function pview($id = null){
	...
	function viewPdf($ref = null){ 
        if (!$ref) 
        { 
            $this->Session->setFlash(__('Désolé, numero de commande invalide.')); 
        ...
        if (empty($property)) 
        { 
            $this->Session->setFlash(__('Désolé, erreur de propriété.')); 
            $this->redirect(array('action'=>'index'), null, true); 
        } 
        ...
        if (!empty($this->request->data)) {
            $this->request->data['Order']['id'] = $id;
                if($this->Order->validates()){
                    ...
                    $this->Session->setFlash(__('Numéro Colissimo enregistré'),"default", array('class' => 'alert-box success radius'));
