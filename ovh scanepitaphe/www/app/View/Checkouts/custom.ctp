...
</div><p><?php echo __('1 - Placez le QR code et le texte sur l\'image.');?><br/>
<?php echo __('2 - Redimensionnez le texte si besoin (en utilisant le petit carré rouge en bas à droite de votre texte).');?><br/>
<?php echo __('3 - Validez pour ajouter à vote panier.');?></p></div>
</div>
<div id="content">
