<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3><?php echo __('Modifier un contenu texte sur la page de');?> <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        <?php
            ...
            echo $this->Form->input('name',array('label' => __('1 - Titre du texte'), 'placeholder'=>__('renseignez le titre de votre texte'),'class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => __('3 - Texte'),'rows' => '5','placeholder'=>__('écrivez votre texte'), 'class' => 'ckeditor'));
