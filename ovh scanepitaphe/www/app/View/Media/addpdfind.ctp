<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3><?php echo __('Ajouter un pdf sur la page de');?> <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        <?php
            ...
            echo $this->Form->input('name',array('label' => __('1 - Ajoutez un titre pour le pdf'), 'placeholder'=>__('renseignez le titre de votre pdf'),'class' => 'ckeditor'));
            ...
            echo $this->Form->input('tags',array('label'=>__('3 - Renseignez des mots clés (séparés par une virgule) (facultatif)').' <a href="#" data-reveal-id="myModal" data-reveal title="'.__('Besoin d\'aide?').'"><i class="fa fa-question-circle"></i></a>
            ...
            echo $this->Form->input('nomfichier_url',array('label' => __('5 - Choississez un fichier pour le pdf'), 'type' => 'file'));
