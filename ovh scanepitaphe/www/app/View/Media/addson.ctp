<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3><?php echo __('Ajouter un contenu sonore (mp3) sur la page d\'une personne');?></h3>
        </div>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        <?php
            ...
            echo $this->Form->input('name',array('label' => __('2 - Ajoutez un titre à ce contenu sonore'), 'placeholder'=>__('renseignez le titre de votre contenu sonore'),'class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => __('4 - Ajoutez une description'),'rows' => '5','placeholder'=>__('description de votre son'), 'class' => 'ckeditor'));
            ...
            echo $this->Form->input('category_id', 
                              array(
                              'label' => __('7 - Choississez une éventuelle catégorie pour ce fichier sonore (facultatif)').' <a href="#" data-reveal-id="myModal2" data-reveal title="'.__('Besoin d\'aide?').'"><i class="fa fa-question-circle"></i></a>
