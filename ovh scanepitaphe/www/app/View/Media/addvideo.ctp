<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3><?php echo __('Ajouter une vidéo sur la page d\'une personne');?></h3>
        </div>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        <?php
            ...
            echo $this->Form->input('name',array('label' => __('2 - Ajoutez un titre pour la vidéo'), 'placeholder'=>__('renseignez le titre de votre vidéo'),'class' => 'ckeditor'));
            echo $this->Form->input('date', array(
                                'label' => __('3 - Renseignez la date de l\'évènement décrit'),
                                'dateFormat' => 'DMY',
                                'minYear' => date('Y') - 2000,
                                'maxYear' => date('Y'),
                                 'separator' =>''
                                ));    
            echo $this->Form->input('content',array('label' => __('4 - Ajoutez une description'),'rows' => '5','placeholder'=>__('description de votre vidéo'), 'class' => 'ckeditor'));
            echo $this->Form->input('tags',array('label'=>__('5 - Renseignez des mots clés (séparés par une virgule) (facultatif)').' <a href="#" data-reveal-id="myModal" data-reveal title="'.('Besoin d\'aide?').'"><i class="fa fa-question-circle"></i></a>
            ...
            echo $this->Form->input('adressevideo',array('label' => __('6 - Ajoutez l\'adresse de la vidéo Youtube').'  <a href="#" data-reveal-id="myModal2" data-reveal title="'.__('Besoin d\'aide?').'"><i class="fa fa-question-circle"></i></a>
                  <div id="myModal2" class="reveal-modal" data-reveal>
                    ...
                    <a class="close-reveal-modal">&#215;</a>
                  </div>', 'placeholder'=>__('coller l\'adresse de la vidéo Youtube')));

            echo $this->Form->input('category_id', 
                              array(
                              'label' => __('7 - Choississez une éventuelle catégorie pour cette vidéo (facultatif)').' <a href="#" data-reveal-id="myModal3" data-reveal title="'.__('Besoin d\'aide?').'"><i class="fa fa-question-circle"></i></a>
