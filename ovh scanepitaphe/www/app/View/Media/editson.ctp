<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3><?php echo __('Modifier un contenu sonore sur la page de');?> <?php echo $this->Html->link($personne['Defunt']['firstname'].' '.$personne['Defunt']['name'],array('controller'=>'defunts','action'=>'editprinc',$personne['Defunt']['id']),array(
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 columns">
        ...
        if(!empty($media['Media']['nomfichier'])){
            ...
            echo $this->Form->input('name',array('label' => __('1 - Titre du contenu sonore'), 'placeholder'=>__('renseignez le titre de votre son'),'class' => 'ckeditor'));
            ...
            echo $this->Form->input('content',array('label' => __('3 - Description du contenu sonore'),'rows' => '5','placeholder'=>__('renseignez une description'), 'class' => 'ckeditor'));
            ...
            echo $this->Form->submit(__('Modifier ce contenu sonore'),array('class'=>'buttonvioletokfull postfix')); 
            echo $this->Form->end();
        ?>
      </div>
    </div>
