<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
            <h3><?php echo __('Famille');?> <?php echo $this->request->data['Family']['name']; ?></h3>
        </div>
    ...
    <div class="row">
        <div class="small-12 medium-12 large-12 tdb lignetop">
                ...
                <?php
                    echo $this->Html->link('<div class="small-12 medium-3b large-3b columns center bgviolet left heightfixe"><i class="fa fa-male" style="padding-bottom:0.1em;"></i><p>'.__('Ajouter une personne (ou groupe de personnes) et créer sa page').'</p></div>',array('controller'=>'defunts','action'=>'add',$this->request->data['Family']['id']),array(
            ...
            <?php
                ...
                foreach ($personnes as $key => $value) {
                    ...
                    echo '<p class="bottom">'.$this->Html->link(__('Modifier'),array('controller'=>'defunts','action'=>'editprinc',$value['Defunt']['id'])).'<br/>'.$this->Html->link(__('Voir la page'),array('controller'=>'clientpages','action'=>'view',$value['Defunt']['id']));
                    echo '</p></div>';
                    }
                ?>
                ...
                <?php
                    ...
                    echo $this->Html->link(__('Supprimer cette famille'),array('controller'=>'families','action'=>'delete',$this->request->data['Family']['id']));
                    echo '</p></div>';
                ?> 
    ...
    <div class="row margecinq">
        <div class="small-12 medium-12 large-12 tdb center">          
                ...
                <?php
                    echo $this->Html->link('<div class="small-12 medium-4b large-4b center bgvert left margergttdb"><i class="fa fa-cog"></i><p>'.__('Paramètres de la famille').'</p></div>',array('controller'=>'families','action'=>'edit',$this->request->data['Family']['id']),array(
                    'escapeTitle' => false, 'title' => __('paramètres de la famille')
                  ));
                ?>                
