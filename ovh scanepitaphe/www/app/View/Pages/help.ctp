<div class="row minha">
    <div class="row">
        <div class="small-12 medium-12 large-12 columns center">
          <h3><?php echo __('Besoin d\'aide ?');?></h3>
        </div>
        ...
        ?>" /></p>
                ...
                <p><label for="nature" class="left">Votre demande concerne :</label><br/>
                   <select name="demande" id="nature" class="combo">
                     ...
                     <option value="Famille">Création famille</option>
                     <option value="Profil">Création profil</option>
                     <option value="Contenu">Ajouter un contenu sur une page</option>
                     <option value="Plaque">Commander sa plaque</option>
